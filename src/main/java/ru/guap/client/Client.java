...
public class Client {
    ...
    JToolBar toolbar; // кноп ки
    JPanel menu; // меню
    JLabel existLabel; // доска существует
    JLabel notFoundLabel; // доска не не найдена
    ...
    class BoardPanel extends JPanel implements Serializable {// объект в байты
        private static final long serialVersionUID = -109728024865681281L;

        public void paintComponent(Graphics g) { //класс для графики
            super.paintComponent(g);
            g.drawImage(board, 0, 0, this);// берет изображение в определенном положение
        }
    }
    ...
    public Client(String serverHost, int serverPort) {
        ...
        toolbar.setBackground(Color.white); // устанавливаем цвет панели
        frame.add(toolbar);
